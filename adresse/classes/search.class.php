...
class search {
  ...
  protected $sql = array(
    ...
    'bal' => 'SELECT cle_interop, uid_adresse, voie_nom, numero, suffixe, commune_nom, position,x, y, long, lat, source, date_derniere_maj FROM adresse.v_export_bal  WHERE code_insee = $1',
