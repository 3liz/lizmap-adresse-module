...
class search {
  ...
  protected $sql = array(
    ...
    'voie_delib'=>'SELECT DISTINCT v.nom_complet FROM adresse.voie v JOIN adresse.point_adresse p ON v.id_voie = p.id_voie JOIN adresse.commune c ON c.id_com = p.id_commune WHERE c.insee_code = $1::text',
