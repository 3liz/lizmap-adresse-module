        ...
        function initCertifView() {
            ...
            $.post(getFeatureUrlData['url'], getFeatureUrlData['options'], function (data) {
                ...
                for (var i = 0; i < features.length; i++) {
                    ...
                    c2Column.append(new Option(features[i]['properties']['commune_nom'], features[i]['properties']['insee_code']));
                }
            });
                ...
                lizMap.getFeatureData(layer_name, layer_filter, null, 'none', false, null, null,
                    function (aName, aFilter, aFeatures) {
                        ...
                        if (features && features.length > 0) {
                            ...
                            for (var i = 0; i < features.length; i++) {
                                var num = features[i]['properties'][propertie1];
                                var suffixe = features[i]['properties'][propertieS];
                                if (typeof propertieS !== 'undefined' && suffixe !== null && suffixe !== '') {
                                    num += ' ' + suffixe;
                                }
                                column.append(new Option(num, features[i]['properties'][propertie2]));
                            }
                        }
                        return false;
                    }
            ...
            $('.btn-certif-num-close').click(function () {
                $('#button-adresse-certificats').click();
                return false;
            });
        }
    }
